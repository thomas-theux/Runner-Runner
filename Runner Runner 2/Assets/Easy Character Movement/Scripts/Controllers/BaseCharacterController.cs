...
namespace ECM.Controllers
{
    ...
    public class BaseCharacterController : MonoBehaviour
    {
        ...
        protected void Jump()
        {
            ...
            // OWN CODE
            AudioManager.instance.PlayRandom("Jumping", 0.7f, 1.2f);
        ...
        protected virtual void HandleInput()
        {
            ...
            {
                x = ReInput.players.GetPlayer(PlayerSheetScript.playerID).GetAxis("LS Horizontal"),
                y = 0.0f,
                z = ReInput.players.GetPlayer(PlayerSheetScript.playerID).GetAxis("LS Vertical"),
            };
